...
controller.combos.attachCombo("baa", function () {
...
scene.setBackgroundImage(img`
    ...
    `)
game.splash("Welcome to the fight arena")
game.splash("This is just a test so hang on")
mySprite = sprites.create(img`
    ...
    . . . . . f f . . f f . . . . . 
    `, SpriteKind.Player)
mySprite2 = sprites.create(assets.image`HOLOU`, SpriteKind.Player)
